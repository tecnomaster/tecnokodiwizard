...
BUILDFILE      = 'https://daanielrodriguez.info/tecnokodiwizard/builds.txt'
...
THEME1         = '[COLOR '+COLOR1+'][B][I]([COLOR '+COLOR2+']TecnoKodi[/COLOR])[/I][/B][/COLOR] Wizard [COLOR '+COLOR2+']%s[/COLOR]'
# Build Names          / %s is the menu item and is required
THEME2         = '[COLOR '+COLOR2+']%s[/COLOR]'
# Alternate items      / %s is the menu item and is required
THEME3         = '[COLOR '+COLOR1+']%s[/COLOR]'
# Current Build Header / %s is the menu item and is required
THEME4         = '[COLOR '+COLOR1+']Paquete Actual:[/COLOR] [COLOR '+COLOR2+']%s[/COLOR]'
...
# Font size of header
FONTHEADER     = 'Font14'
HEADERMESSAGE  = '[B][COLOR dodgerblue]TecnoKodi[/COLOR][/B] Wizard'
