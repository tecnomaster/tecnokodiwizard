...
base='https://github.com/tecnomaster/tecnokodiwizard'
ADDON=xbmcaddon.Addon(id='plugin.program.tecnokodiwizard')
    
    
VERSION = "1.0"


PATH = "tecnokodiwizard"

dp           =  xbmcgui.DialogProgress()
dialog       =  xbmcgui.Dialog()
EXCLUDES     = ['plugin.program.tecnokodiwizard', 'Database']
HOME         =  xbmc.translatePath('special://home/')

    
def CATEGORIES():
    link = OPEN_URL('https://raw.githubusercontent.com/tecnomaster/tecnokodiwizard/master/wizard/wizard.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("tecnokodiwizard","Descargando ",'', 'Por favor, espere')
...
def FRESHSTART(params):
    ...
    choice2 = xbmcgui.Dialog().yesno("Borrar todo el contenido?", '[COLOR=red]Estas seguro de borrar todo el contenido?[/COLOR]', 'Se borrara todo [B]menos[/B] el addon [COLOR=orange][B]tecnokodiwizard[/B][/COLOR] y tu [COLOR=lime][B]Videoteca[/B][/COLOR]', yeslabel='Si',nolabel='No')
    if choice2 == 0:
        return
    elif choice2 == 1:
