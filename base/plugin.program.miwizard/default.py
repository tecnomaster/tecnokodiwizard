...
base='https://github.com/tecnomaster/base/'
ADDON=xbmcaddon.Addon(id='plugin.program.miwizard')
...
EXCLUDES     = ['plugin.program.miwizard', 'Database']
HOME         =  xbmc.translatePath('special://home/')

    
def CATEGORIES():
    link = OPEN_URL('http://dominio.ext/carpeta/wizard.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("MiWizard","Descargando ",'', 'Por favor, espere')
...
def FRESHSTART(params):
    ...
    choice2 = xbmcgui.Dialog().yesno("Borrar todo el contenido?", '[COLOR=red]Estas seguro de borrar todo el contenido?[/COLOR]', 'Se borrara todo [B]menos[/B] el addon [COLOR=orange][B]MiWizard[/B][/COLOR] y tu [COLOR=lime][B]Videoteca[/B][/COLOR]', yeslabel='Si',nolabel='No')
    if choice2 == 0:
        return
    elif choice2 == 1:
